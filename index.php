      ...
      <section id="testimonials" class="section-bg">
        <div class="container" data-aos="fade-up">
          ...
          <div class="owl-carousel testimonials-carousel">
            ...
            <div class="testimonial-item">
              <img src="assets/img/rutus.jpg" class="testimonial-img" alt="">
              <h3>Ritesh</h3>
              <h4>Manager</h4>
              <p>
                <img src="assets/img/quote-sign-left.png" class="quote-sign-left" alt="">
                Rutus holidays resort panhala aim to provide the best and a comfortable living to all our guests so that they make the most of their stay and have memories.
                <img src="assets/img/quote-sign-right.png" class="quote-sign-right" alt="">
              </p>
            </div>
      ...
      <div class="row contact-info">
        ...
        <div class="col-md-4">
          <div class="contact-email">
            ...
            <contact@travelogimmigration.com>
